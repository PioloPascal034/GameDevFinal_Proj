...
public class Constants {
	...
	public static class ObjectConstants {
		...
		public static final int RED_AMMO = 10;
		public static final int BLUE_AMMO = 11;
		...
		public static final int RED_AMMO_VALUE = 10;
		public static final int BLUE_AMMO_VALUE = 5;
		...
		public static final int AMMO_WIDTH_DEFAULT = 12;
		public static final int AMMO_HEIGHT_DEFAULT = 16;
		public static final int AMMO_WIDTH = (int) (Game.SCALE * AMMO_WIDTH_DEFAULT);
		public static final int AMMO_HEIGHT = (int) (Game.SCALE * AMMO_HEIGHT_DEFAULT);
	...
	public static class EnemyConstants {
        ...
        public static final int GOTOKU = 3;
        public static final int MEDUSSA = 4;
        public static final int ONRE = 5;
        public static final int YUREI = 6;
		// Lesser enemies (from /res/lesser enemies)
		public static final int SKELETON_ARCHER = 7;
		public static final int SKELETON_SPEARMAN = 8;
		public static final int SKELETON_WARRIOR = 9;
		public static final int WILD_ZOMBIE = 10;
		public static final int ZOMBIE_MAN = 11;
		public static final int ZOMBIE_WOMAN = 12;
		...
		public static int GetSpriteAmount(int enemy_type, int enemy_state) {
			...
			case IDLE: {
				if (enemy_type == CRABBY)
					...
					return 8;
				else if (enemy_type == GOTOKU || enemy_type == MEDUSSA || enemy_type == ONRE || enemy_type == YUREI)
					return 10;
				else if (enemy_type == SKELETON_ARCHER || enemy_type == SKELETON_SPEARMAN || enemy_type == SKELETON_WARRIOR || enemy_type == WILD_ZOMBIE || enemy_type == ZOMBIE_MAN || enemy_type == ZOMBIE_WOMAN)
					return 8;
			}
			case RUNNING:
				return 6;
